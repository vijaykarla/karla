...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void loginProceed(boolean granted)
    {
        if(granted) {
            if (false) {
    ...
    private void requestPepPermissions() {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
			...
			String responseText;
            try {
                String apiUrl = "http://peptrack.com/api/v1.0/data/usertracks?loginId=" + mEmail + "&loginPassword=" + mPassword;
        ...
        protected void onPostExecute(String response) {
            ...
            if(response == null || response == "Error") {				
				...
				try {
					...
					trackId = obj.getInt("TrackId");
					trackUrlName = obj.getString("TrackUrlName");
					trackingKey = obj.getString("TrackingKey");
